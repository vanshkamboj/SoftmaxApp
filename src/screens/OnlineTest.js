        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <WebView
                    ...
                    source={{ uri: "https://softmax.info/questionBank/studentPanel/test_info.php?username=" + userArr[0].school_name + "&class=" + userArr[0].class + "&rollnum=" + userArr[0].student_id }}
                    style={{ flex: 2 }}
                />
                {this.state.visible && (
                    <ActivityIndicator
