            ...
            <View style={{ flex: 1 }}>
                ...
                <View style={{ backgroundColor: color }}>
                    <View style={{
                        ...
                        <Text style={{ color: 'white', fontSize: 20 }}>Syllabus/TimeTable</Text>
                        <TouchableOpacity
                ...
                <WebView
                    ...
                    source={{ uri: "https://softmax.info/uploadpic/" + userArr[0].school_name + "/" + userArr[0].class + "/doc/" + this.props.filename }}
                    style={{ flex: 2 }}
                />
                {this.state.visible && (
                    <ActivityIndicator
