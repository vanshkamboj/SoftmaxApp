...
import {getProfile, reset, saveUserTime} from '../actions';
...
class DeshBoard extends Component {
  componentDidMount() {
    ...
    if (this.props.userArr != null) {
      this.getData();
      saveUserTime(
        this.props.userArr[0].student_id,
        this.props.userArr[0].mobile,
        new Date().getTime(),
      );
    }
  ...
  logOutUser = () => {
    Alert.alert(
      ...
      [
        ...
        {
          text: 'No',
          onPress: () => console.log('User not signout'),
          style: 'cancel',
        },
      ],
      {
        ...
        <KeyboardAwareScrollView
          ...
          <View style={{flex: 1, height: screenHeight, width: screenWidth}}>
            ...
            <View
              ...
              <TouchableOpacity onPress={() => alert(this.props.notice)}>
                <TextTicker
                  style={{fontSize: 24, marginVertical: 20}}
                  duration={20000}
                  loop
              ...
              <View style={{flexDirection: 'row'}}>
                ...
                <TouchableOpacity
                  ...
                  />
                  <Text style={{fontWeight: 'bold'}}>Diary Pics</Text>
                </TouchableOpacity>
                <TouchableOpacity
                  style={styles.cards}
              ...
              <View style={{flexDirection: 'row'}}>
                <TouchableOpacity
                  style={styles.cards}
                  onPress={() =>
                    Actions.syllabus({filename: 'Time_table.jpg'})
                  }>
                  <Image
