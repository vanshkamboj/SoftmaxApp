...
import {getDairyPics, getHomeworkFromDate} from '../actions';
          ...
          <View
            ...
            <View
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      ...
                      <Text style={{fontWeight: 'bold'}}>
                        Click here to Select Homework date
                      </Text>
                    </TouchableOpacity>
                    ...
                    <Text
                      ...
                      {this.props.homework !== null
                        ? this.props.homework !== undefined
                          ? this.props.homework
                          : 'HomeWork(Text) Not Found Also Check HomeWork in Dairy pics'
                        : 'HomeWork(Text) Not Found Also Check HomeWork in Dairy pics'}
                    </Text>
              ...
              <View style={{position: 'absolute', bottom: 100}}>
                <Text style={{fontWeight: 'bold'}}>
                  ALSO CHECK Dairy PIC FOR HOMEWORk
                </Text>
              </View>
            </View>
                        ...
                        <TouchableOpacity
                          onPress={() => {
                            ...
                            if (this.state.selectedDate !== null) {
                              this.props.getHomeworkFromDate(
                                userArr[0].class,
