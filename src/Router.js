    ...
    <Router
      ...
      <Scene key="root" hideNavBar>
        <Scene key="auth">
          ...
          <Scene key="video" component={OnlineVideo} hideNavBar={true} />
          <Scene key="E_learning" component={E_learning} hideNavBar={true} />
          <Scene key="Books" component={Books} hideNavBar={true} />
          <Scene key="test" component={OnlineTest} hideNavBar={true} />
          <Scene
            key="BooksSubject"
            component={BooksSubject}
            hideNavBar={true}
          />
          ...
          <Scene key="reportCard" component={ReportCard} hideNavBar={true} />
          <Scene key="syllabus" component={Syllabus} hideNavBar={true} />
          <Scene key="marks" component={Marks} hideNavBar={true} />
          <Scene key="gallary" component={Gallary} hideNavBar={true} />
          <Scene key="showGallary" component={ShowGallary} hideNavBar={true} />
          <Scene key="policy" component={Policy} hideNavBar={true} />
          <Scene key="zoom" component={Zoom} hideNavBar={true} />
        </Scene>
        {/* <Scene key='main'> */}
